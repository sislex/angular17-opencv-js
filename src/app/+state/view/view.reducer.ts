...
export const initialViewState: IViewState = {
  sideMenu:  [
    ...
    {name: 'Image from internal camera', data: {isVideo: true, scaleRecognition: 2, recognitionInterval: 100}},
    {name: 'Image from external camera', data: {src: 'http://192.168.20.135:8080/video', isVideo: true, scaleRecognition: 1, recognitionInterval: 100}},
